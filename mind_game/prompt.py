...
MAP_INSTRUCTIONS_LAYER = (
    ...
    "outside rooms. Use digits 1-9 for NPCs or named characters present in the scene (one digit "
    "per NPC placed on a floor tile, maximum 3 NPCs). "
    "Spread described rooms across the viewport when the scene contains multiple "
